...
public class TileColors {
	...
	/**
	 * Color for ungenerated - red to show error
	 */
	public static final Color UNGENERATED_COLOR = new Color(100, 0, 0);
	
	/**
	 * Color for ocean - deep blue
	 */
	public static final Color OCEAN_COLOR = new Color(0, 25, 100);
	
	/**
	 * Color for sea - lighter blue
	 */
	public static final Color SEA_COLOR = new Color(0, 100, 200);
	
	/**
	 * Color for plains - light green
	 */
	public static final Color PLAINS_COLOR = new Color(120, 200, 30);
