...
public class ErrorFileWatcher {
	...
	public void check() {
		...
		if(actualLastTime != this.lastTime) {
			JOptionPane.showMessageDialog(null, "An error has occurred. Please find your " + System.getProperty("user.dir") + "/" + Main.ERROR_LOG + " file and send the error message to a dev.");
			System.exit(0);
		}
	}
}
